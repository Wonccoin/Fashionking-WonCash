...
#if defined(NDEBUG)
# error "FashionkingWoncash cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "FashionkingWoncash Signed Message:\n";
                  ...
                  CCoinsViewCache& view, const CChainParams& chainparams, bool fJustCheck)
{
    ...
    // FashionkingWoncash also requires DER encoding of pubkeys
    flags |= SCRIPT_VERIFY_DERKEY;
    // FashionkingWoncash also requires low S in sigs
