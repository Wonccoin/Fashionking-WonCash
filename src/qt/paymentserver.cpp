...
const QString BITCOIN_IPC_PREFIX("fashionkingwoncash:");
// BIP70 payment protocol messages
const char* BIP70_MESSAGE_PAYMENTACK = "PaymentACK";
const char* BIP70_MESSAGE_PAYMENTREQUEST = "PaymentRequest";
// BIP71 payment protocol media types
const char* BIP71_MIMETYPE_PAYMENT = "application/fashionkingwoncash-payment";
const char* BIP71_MIMETYPE_PAYMENTACK = "application/fashionkingwoncash-paymentack";
const char* BIP71_MIMETYPE_PAYMENTREQUEST = "application/fashionkingwoncash-paymentrequest";
    ...
    optionsModel(0)
{
    ...
    // on Mac: sent when you click fashionkingwoncash: links
...
//
// OSX-specific way of handling fashionkingwoncash: URIs and PaymentRequest mime types.
...
void PaymentServer::initNetManager()
{
    ...
    // netManager is used to fetch paymentrequests given in fashionkingwoncash: URIs
...
void PaymentServer::handleURIOrFile(const QString &s)
{
    ...
    // fashionkingwoncash: CashAddr URI
