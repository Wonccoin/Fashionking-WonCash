    ...
    QWidget(0, f), curAlignment(0)
{
    ...
    QString copyrightTextFashionkingWoncash   = QChar(0xA9)+QString(" %1 ").arg(2021) + QString("The FashionkingWoncash developers");
    ...
    // draw copyright stuff
    {
        ...
        pixPaint.drawText(x,y+30,copyrightTextFashionkingWoncash);
    }
