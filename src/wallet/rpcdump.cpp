...
UniValue dumpprivkey(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() != 1)
        throw runtime_error(
            "dumpprivkey \"fashionkingwoncashaddress\"\n"
            "\nReveals the private key corresponding to 'fashionkingwoncashaddress'.\n"
            "Then the importprivkey can be used with this output\n"
            "\nArguments:\n"
            "1. \"fashionkingwoncashaddress\"   (string, required) The fashionkingwoncash address for the private key\n"
            "\nResult:\n"
